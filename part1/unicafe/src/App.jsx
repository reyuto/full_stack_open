...
const StatisticsItem = ({text, value}) => <div>{text} {value}</div>
const Statistics = ({good, neutral, bad}) => {
  ...
  return (
    <div>
      ...
      {total > 0 ? (
        <>
          <StatisticsItem text="average" value={(good * 1 + bad * -1) / total} />
          <StatisticsItem text="positive" value={`${good * 100 / total} %`} />
        </>
      ) : null}
